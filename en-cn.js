...
(function () {
    ...
    const RAW_REGEX_RULES = [
        ...
        //其他道具
        [/^Daily export rewards award an extra Fashion Case/i,
        '每日导出奖励额外获得 1 个饰品盒'],
        [/^Trainers in the battle frontier award \+3 extra Golden Bottle Caps/i,
        '对战开拓区的训练家额外奖励 3 个金色皇冠'],
        [/^Decrease the time required for genetic operations by 30 minutes \(Up to a minimum of 10 minutes\)/i,
        '减少遗传所需时间 30 分钟 (最低至 10 分钟)'],
